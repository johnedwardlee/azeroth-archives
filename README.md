...
- Guided level advancement with subclass checks, hit-point increases, feats, ability improvements, Expertise, Metamagic, spell choices, Fighting Styles, and Weapon Masteries
- Living hit points, temporary hit points, death saves, hit dice, inspiration, conditions, rests, class resources, concentration, and active effects
...
The approved Warcraft campaign pack is included and updated with the application. Additional schema-compatible `.w5e` packs can be imported from the Content Library.
...
- Multiclass progression is not currently supported.
